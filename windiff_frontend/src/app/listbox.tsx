    ...
    <Listbox value={value} onChange={onChange}>
      <div className="relative mt-1">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <Listbox.Options className="z-20 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-gray-800 text-gray-50 py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
